  ...
  return (
    <Dialog>
      ...
      <DialogTrigger asChild>
        <motion.div
          whileHover={{ y: -8 }}
          className="group cursor-pointer relative bg-[#0d0d0d] border border-white/10 rounded-2xl overflow-hidden hover:border-primary/40 transition-all duration-500 shadow-xl"
        >
          <div className="relative h-64 overflow-hidden">
            ...
            <div className="absolute top-4 left-4">
              <span className="px-3 py-1 text-[10px] font-bold tracking-widest uppercase text-white bg-black/60 backdrop-blur-md border border-white/20 rounded-full">
                {category}
              </span>
            </div>
          </div>
      ...
      {/* --- MODAL CONTENT --- */}
      <DialogContent className="max-w-6xl p-0 bg-[#050505] border-white/10 overflow-hidden rounded-[2rem] shadow-2xl z-[10000] outline-none">
        <DialogClose className="absolute right-6 top-6 z-50 rounded-full p-3 bg-black/60 backdrop-blur-xl border border-white/10 text-white hover:bg-primary hover:text-black transition-all focus:outline-none active:scale-90">
          <X className="h-5 w-5" />
        </DialogClose>

        <div className="overflow-y-auto max-h-[90vh] custom-scrollbar">
          {/* IMAGE SLIDER */}
          <div className="relative h-[300px] sm:h-[550px] w-full bg-[#080808] border-b border-white/5">
            <Swiper
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h3 className="text-white font-bold text-2xl mb-8 flex items-center gap-3">
                  <span className="w-8 h-[1px] bg-primary"></span> Core Features
                </h3>
              ...
              <div className="space-y-8">
                <h3 className="text-white font-bold text-2xl mb-8 flex items-center gap-3">
                  <span className="w-8 h-[1px] bg-red-500"></span> Technical
                  Challenges
                </h3>
                <div className="space-y-4">
                ...
                <div className="space-y-8">
                  <h3 className="text-2xl font-bold text-white flex items-center gap-3">
                    <Layers className="w-5 h-5 text-primary" /> Stack
                  </h3>
                  <div className="flex flex-wrap gap-2">
                    {technologies.map((tech, i) => (
                      <span
                        key={i}
                        className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 hover:text-white/50 text-xs font-medium text-primary hover:border-primary/40 transition-colors"
                      >
                        {tech}
                      </span>
                    ))}
