...
import devImage from "../../assets/developer-portrait.jpg";
          ...
          <div className="text-left">
            ...
            <FadeIn delay={100}>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6 leading-tight">
                Crafting Scalable Full-Stack Experiences
              </h1>
            </FadeIn>

            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-[550px] mb-8">
                Specialized in building robust, data-driven applications using
                MongoDB, Express, React, and Node.js. Expertly leveraging
                Next.js for SEO-optimized, lightning-fast web performance.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={300}>
              <button
                ...
                className="inline-flex items-center gap-0 mb-12 group cursor-pointer"
              >
