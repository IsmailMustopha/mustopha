    ...
    <footer className="relative bg-black overflow-hidden border-t border-white/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <FadeIn delay={0}>
            <div>
              {/* Logo / Name (First name only) */}
              <h3 className="text-3xl font-bold bg-linear-to-r from-primary/80 via-primary to-primary bg-clip-text text-transparent mb-4">
              ...
              <div className="space-y-3">
                ...
                <div className="group flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl hover:border-primary/30 transition-all duration-300">
                  <div className="p-2 bg-primary/10 rounded-lg">
                ...
                {NAV_LINKS.map((link) => (
                  <li key={link.id}>
                    ...
                    >
                      ...
                      <div className="w-1.5 h-1.5 rounded-full bg-white/30 group-hover:bg-primary group-hover:scale-125 transition-all duration-300" />
                ...
                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                  ...
                  return Icon ? (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/5 rounded-xl transition-all" />
                    </a>
                  ) : null;
                })}
              </div>
